...
{
    class Wagon3Spawn : SimpleUseable
    {
        public Wagon3Spawn(BaseCharacter owner, string name, float cooldown) : base(owner)
        {
            Name = name;
            Cooldown = cooldown;
        }
        ...
        protected override void Activate()
        {
            ...
            try
            {
                ...
                GameObject WagonObj = PhotonNetwork.Instantiate("Buildables/Wagon2bHawk", pos, Quaternion.identity);
