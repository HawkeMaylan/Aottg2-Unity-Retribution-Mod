...
namespace Characters
{
    class Airburst1Spawn : SimpleUseable
    {
        ...
        protected override void Activate()
        {
            ...
            if (inventory.GetItemCount("AirburstCompressorLvl1") <= 0)
            {
                Debug.Log("Not enough Cannon count to spawn.");
                inventory.SetItemCount("AirburstCompressorLvl1", -1); // Triggers "Not Enough Cannon" popup
                return;
            }
            ...
            try
            {
                ...
                inventory.RemoveItem("AirburstCompressorLvl1"); // Handles RPC and shows "-1" popup
            }
