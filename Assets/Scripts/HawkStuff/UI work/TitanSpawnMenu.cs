...
public class TitanSpawnMenu : MonoBehaviourPun
{
    ...
    private string[] titanTypes = new string[] { "Normal", "Abnormal", "Jumper", "Crawler", "Thrower", "Punk", "Aberrant", "Strider", "Twin" };
    ...
    private string[] weightInputs = new string[] { "10", "10", "10", "10", "10", "10", "10", "10", "10" };
